...
#else
let codeFont = UIFont.WenKaiMonoBold(size: 14)
...
let lighterColor = UIColor.chenXiHong
let textColor = UIColor.yuDuBai
#endif

public extension Sequence where Iterator.Element == HighlightRule {
    static var customMarkdownRules: [HighlightRule] {
        [
